...
// Realizes dinamic indication and shows to you number 
// from an argument list
void PrintNumber(int counter, double number)
{
  // Variable for splitting of an input number
  //
  // Unfortunately there is a need to declare 
  // this variable right here for the sake of fast work.
  // This one is not used in another parts of programm.
  int coma = 0;
  int mult = 0;
